...
*/
public static String version()      {  return "1.4.0"  }
...
void sunRiseSetHandler(resp, data) {
    if(resp.getStatus() == 200 || resp.getStatus() == 207) {
        ...
        log.warn "DarkSky.net Weather Driver WARNING: Sunrise-Sunset api did not return data" + resp.getStatus() + ":" + resp.getErrorMessage()
    }
}
